...
Public Class AttendanceProcessedSingleEntries
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AttendanceProcessedSingleEntries.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "THA_Payroll.AttendanceProcessedSingleEntries.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PayrollDate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAttendanceProcessedSingleEntries
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AttendanceProcessedSingleEntries = New AttendanceProcessedSingleEntries()
        rpt.Site = Me.Site
        Return rpt
    End Function
