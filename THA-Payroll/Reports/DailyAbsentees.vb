...
Public Class DailyAbsentees
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "THA_Payroll.DailyAbsentees.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyAbsentees
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyAbsentees = New DailyAbsentees()
        rpt.Site = Me.Site
        Return rpt
    End Function
