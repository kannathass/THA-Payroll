...
Public Class AttendanceActualAbsentees
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AttendanceActualAbsentees.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "THA_Payroll.AttendanceActualAbsentees.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_EnrollDate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAttendanceActualAbsentees
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AttendanceActualAbsentees = New AttendanceActualAbsentees()
        rpt.Site = Me.Site
        Return rpt
    End Function
