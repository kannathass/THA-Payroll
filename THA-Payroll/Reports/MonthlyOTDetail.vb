...
Public Class MonthlyOTDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "THA_Payroll.MonthlyOTDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlyOTDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlyOTDetail = New MonthlyOTDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
