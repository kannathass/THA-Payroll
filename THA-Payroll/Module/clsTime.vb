...
Public Class clsTime
    ...
    Public Overrides Property CellTemplate() As DataGridViewCell
        ...
        Set(ByVal value As DataGridViewCell)
            ...
            ' Ensure that the cell used for the template is a CalendarCell1.
...
Public Class CalendarCell1
    ...
    Public Sub New()
        ...
        Me.Style.Format = DateTimePickerFormat.Time
    End Sub
    ...
    Public Overrides Sub InitializeEditingControl(ByVal rowIndex As Integer, _
        ...
        'ctl.Value = CType(Me.Value, DateTime)          'hide by murthy
        ctl.Value = Me.Value
    ...
    Public Overrides ReadOnly Property EditType() As Type
        Get
            ' Return the type of the editing contol that CalendarCell1 uses.
    ...
    Public Overrides ReadOnly Property ValueType() As Type
        Get
            ' Return the type of the value that CalendarCell1 contains.
